  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        sahfy: {
          navy: 'hsl(var(--sahfy-navy))', 'navy-light': 'hsl(var(--sahfy-navy-light))',
          gold: 'hsl(var(--sahfy-gold))', 'gold-light': 'hsl(var(--sahfy-gold-light))',
          cream: 'hsl(var(--sahfy-cream))', slate: 'hsl(var(--sahfy-slate))'
        }
      },
      fontFamily: {
      ...
      boxShadow: {
        sahfy: 'var(--shadow-lg)', gold: 'var(--shadow-gold)',
